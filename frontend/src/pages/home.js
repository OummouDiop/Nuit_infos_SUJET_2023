    ...
    <div className="home-container">
      ...
      <section className="hero">
        ...
        <div className="hero-buttons">
          <button className="btn btn-primary">⚡ Commencer le Quiz</button>
      ...
      <section className="cta-section">
        <h2>Prêt·e à démêler le vrai du faux ?</h2>
        <p>
          Testez vos connaissances sur le climat et découvrez les solutions qui
          font vraiment la différence.
        </p>
        <button className="btn btn-primary btn-large">⚡ Lancer le Quiz</button>
